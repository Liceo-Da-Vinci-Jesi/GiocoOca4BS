...
class Statistiche(wx.Frame):
    def __init__(self,classifica):
        ...
        for n in classifica:
            ...
            posiz = wx.StaticText(panel,label = str(classifica.index(n)+1) + "°")
            ...
            wx_image = wx.Image(n.icona50.size[0], n.icona50.size[1])
            wx_image.SetData(n.icona50.convert("RGB").tobytes())
