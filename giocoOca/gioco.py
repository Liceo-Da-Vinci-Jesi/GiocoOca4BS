...
class Gioco:
    ...
    def GiocaTurnoDi(self,event):
        if not self.attesaDomanda:
            ...
            quest = domanda.scegliDomandaDaFare(self.listaTipoCaselle[self.turnoGiocatore.posizione-1].tipo,self.listaDomande)
            self.finestraDomanda = domanda.FinestraDomanda(quest,self.turnoGiocatore,self.listaTipoCaselle[self.turnoGiocatore.posizione-1].tipo)
